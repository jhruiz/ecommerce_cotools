...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/css/list-groups/groups.css">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12" style="margin-bottom: 15px;">
            ...
            <span id="catSelec"></span>
            <span id="gruSelec"></span>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <h4> Categorías </h4>
            <div class="list-group" id="listaCat" style="margin-top: 10px;"></div>
          </div>
          ...
          <div class="col-md-9">
            ...
            <div class="container">
              <div class="row" id="grd_grupos"></div>            
            </div>
      ...
      <div class="container" style="margin-top: 15px;">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="dropdown-divider"></div>
            <div class="row" id="grd_items_grupos"></div>
          </div>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="form-group col-md-7">
                  ...
                  <input type="text" class="form-control" val="" id="uniFactor" style="color: #c0bcbc;" onblur="restaurarUniFactor()" pattern="[0-9]+" onkeyup="validarNumeros()">
    ...
    <script src="assets/js/categories/categories.js"></script>
